...
class CRM_Report_Form_Grant_Detail extends CRM_Report_Form {
  ...
  protected $_countryField = FALSE;

  protected $_worldRegionField = FALSE;

  protected $_customGroupExtends = array(
    'Grant', 'Contact', 'Individual', 'Household', 'Organization');
  ...
  function from() {
    ...
    if ($this->_countryField && !$this->_worldRegionField) {
	$this->_from .= "LEFT JOIN civicrm_country {$this->_aliases['civicrm_country']}
                   ON {$this->_aliases['civicrm_country']}.id ={$this->_aliases['civicrm_address']}.country_id";
    }
  }
